...
elements.forEach((value, key) => {
    ...
    let periodSquareContent = `<small class="element-atomic-number">${elementMap.atomic_number}</small><b class="element-symbol">${key}</b><abbr class="lang lang-periodic element-name" name="element.${elementMap.name}"></abbr><small id="Periodic-Element${elementMap.atomic_number}-Data" class="element-atomic-mass"></small>`
...
elementInfoRows.forEach((e, i) => {
    PeriodicInfoElementTableRows[i] = `<li id="Periodic-Info-${e}" class="table-row"><small class="lang lang-periodic table-el" name="element.${e}"></small><small id="Periodic-Info-${e}-Data" class="table-el-desc"></small></li>`
})
